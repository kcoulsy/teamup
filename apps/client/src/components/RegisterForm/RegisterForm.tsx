  ...
  return (
    <Card title='Register' size='small' className='register-form__card'>
      ...
      >
                ...
                try {
                  ...
                  if (err instanceof ZodError) {
                    return Promise.reject(
                      new Error(`${err?.errors.map(({ message }) => message).join('\r\n')}.`),
                    );
                  }
        ...
        {registerError ? <Form.Item>Something went wrong trying to register you</Form.Item> : null}
        <Form.Item>
          <Button type='primary' htmlType='submit' loading={isRegistering}>
            Register
          </Button>
          <Button type='link' htmlType='button' onClick={() => history.push(PATH_LOGIN)}>
